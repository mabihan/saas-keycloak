...
class DeleteAllTenantsGatewayImpl(private val tenantRepository: TenantRepository, private val realmRepository: RealmRepository, private val entityManager: EntityManager): DeleteAllTenantsGateway {
